...
export const Features=()=> {
  return (
    <View style={{height:hp(60,)}} className="spacr-y-4">
...
{/* /////////////////////////////////////////////////////////// */}
<View className="bg-purple-200 p-4 rounded-xl space-y-2 m-2">
        <View className="flex-row items-center space-x-1">
      ...
      {/* ////////////////////////////////////////////////////////// */}
      <View className="bg-cyan-200 p-4 rounded-xl space-y-2 m-2">
        <View className="flex-row items-center space-x-1">
